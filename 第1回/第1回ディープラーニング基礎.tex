...
\begin{document}
	...
	\begin{frame}{ニューロンの働きの数理的解釈}
		\begin{figure}
			\centering
			\includegraphics[width=0.7\linewidth]{ニューロンの数理的解釈}
		\end{figure}
		\begin{itemize}
	...
	\begin{frame}{発火の条件のグラフ表現}
		\begin{figure}
			\centering
			\includegraphics[width=0.9\linewidth]{発火の条件のグラフ}
		\end{figure}
	\end{frame}
	\begin{frame}{発火の式}
		\begin{itemize}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.5\linewidth]{単位ステップ関数}
		\end{figure}
		\begin{itemize}
	...
	\begin{frame}{ユニット}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.7\linewidth]{ユニット}
		\end{figure}
	\end{frame}
	\begin{frame}{活性化関数}
		\begin{itemize}
	...
	\begin{frame}{活性化関数の代表例}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.5\linewidth]{単位ステップ関数とシグモイド関数}
		\end{figure}
	\end{frame}
	\begin{frame}{「発火の有無」から「興奮度」へ}
		\begin{figure}
			\centering
			\includegraphics[width=0.8\linewidth]{ユニットの興奮度小}
		\end{figure}
		\begin{equation*}
	...
	\begin{frame}{「発火の有無」から「興奮度」へ}
		\begin{figure}
			\centering
			\includegraphics[width=0.8\linewidth]{ユニットの興奮度大}
		\end{figure}
		\begin{equation*}
			y = \sigma(w_1x_1 + w_2x_2 + w_3x_3 - \theta) 
		\end{equation*}
	...
	\begin{frame}{ユニットのまとめ}
		\begin{figure}
			\centering
			\includegraphics[width=0.8\linewidth]{ユニットのまとめ}
		\end{figure}
	...
	\begin{frame}{ニューラルネットワーク（Neural Network; NN）}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.4\linewidth]{階層型ニューラルネットワーク}
		\end{figure}
	\end{frame}
	\begin{frame}{ニューラルネットワークを用いた問題の具体例}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.5\linewidth]{0と1の画像の例}
		\end{figure}
	\end{frame}
	\begin{frame}{ニューラルネットワークを用いた問題の具体例}
		\underline{解答例}
		\begin{figure}
			\centering
			\includegraphics[width=0.6\linewidth]{具体的なニューラルネットワークの解答例}
		\end{figure}
	\end{frame}
\end{document}
